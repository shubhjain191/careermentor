...
export default function ResumeBuilder({ initialContent }) {
  ...
  } = useFetch(improveWithAI); // Use the AI improvement function
  ...
  useEffect(() => {
    if (improvedSummary && !isImprovingSummary) {
      setValue("summary", improvedSummary); // Update the summary field with the improved content
  ...
  // Function to handle AI improvement for the summary
  const handleImproveSummary = async () => {
    ...
    await improveSummaryFn({
      current: summary,
      type: "summary", // Specify the type as "summary"
    });
  };
